...
const ServiceCard: React.FC<ServiceCardProps> = ({ icon, title, description, features }) => (
  <div className="glass-card rounded-2xl p-8 hover-glow transition-all duration-300 transform hover:scale-105">
    <div className="w-12 h-12 bg-primary-500 rounded-lg flex items-center justify-center mb-6" aria-hidden="true">
      {icon}
    </div>
    <div className="sr-only">
      <span aria-label={`${title} service icon`}>{title} - Automation Engineering</span>
    </div>
